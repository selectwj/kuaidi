...
<div class="main">
    ...
    <form action="http://localhost:8080/my_express_station/staffServlet" method="post" class="form">
        ...
        用户名: <input type="text", name="username" value="<%=request.getAttribute("username")==null?"":request.getAttribute("username")%>"><br>    <!--输入的用户名保存到username变量，传回后端-->
        密码 : <input type="password", name="password"><br>
<%--        <a href="../station/yizhanxuqiu.jsp">--%>
        <input type="submit" value="登录">
        </a>
        <a href="http://localhost:8080/my_express_station/pages/staff/wkregister.jsp">
