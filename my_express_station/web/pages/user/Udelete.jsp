...
<head>
    ...
    <style>
        body {
            background-image: url("http://localhost:8080/my_express_station/static/picture/222.png");
    ...
    <link rel="icon" type="image/x-icon" href="333.jpg">
</head>
<body>
<div class="main">
    <h2>用户删除</h2>
